...
export default keyMirror({
    FETCH_USERINFO: null,
    CLEAR_USERINFO: null,
    FETCH_SUCCEED_USERINFO: null,
    FETCH_FAILURE_USERINFO: null,
    FETCH_SIGNIN: null,
    FETCH_SUCCEED_LOGIN: null,
    FETCH_FAILURE_LOGIN: null,
    FETCH_SIGNUP: null,
    FETCH_SUCCEED_REGISTER: null,
    FETCH_FAILURE_REGISTER: null,
});
